...
namespace frmSplash
{
    public partial class frmIntermediate3 : Form
    {
        public frmIntermediate3()
        {
            InitializeComponent();
            List<string> awnsers = new List<string>();
            awnsers.Add("Hard Drive");
            awnsers.Add("SD Card");
            awnsers.Add("Micro SD");
            awnsers.Add("Processer");
        ...
        private void frmQuestion7_Load(object sender, EventArgs e)
        {
