...
namespace frmSplash
{
    public partial class frmAdvanced5 : Form
    {
        public frmAdvanced5()
        {
            InitializeComponent();
            ...
            awnsers.Add("Converts Pictures into computer Usable code");
            awnsers.Add("Reads the Data off of a Magnetic Strip");
            awnsers.Add("Converts written documents to Computer Code");
            awnsers.Add("Coverts magnetic strip Data To User readable text");
        ...
        private void btnNextQuestion_Click(object sender, EventArgs e)
        {
            ...
            if (rb1.Checked && rb1.Text == "Converts written documents to Computer Code" || rb2.Checked && rb2.Text == "Converts written documents to Computer Code" || rb3.Checked && rb3.Text == "Converts written documents to Computer Code" || rb4.Checked && rb4.Text == "Converts written documents to Computer Code")
            {
        ...
        private void frmQuestion12_Load(object sender, EventArgs e)
        {
