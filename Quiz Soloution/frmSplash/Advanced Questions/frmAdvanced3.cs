...
namespace frmSplash
{
    public partial class frmAdvanced3 : Form
    {
        public frmAdvanced3()
        {
            ...
            awnsers.Add("Central Processing Unit");
            awnsers.Add("Core Processing Unit");
            awnsers.Add("Central Power Unit");
            awnsers.Add("Core Power Unit");
        ...
        private void btnNextQuestion_Click(object sender, EventArgs e)
        {
            ...
            if (rb1.Checked && rb1.Text == "Central Processing Unit" || rb2.Checked && rb2.Text == "Central Processing Unit" || rb3.Checked && rb3.Text == "Central Processing Unit" || rb4.Checked && rb4.Text == "Central Processing Unit")
            {
