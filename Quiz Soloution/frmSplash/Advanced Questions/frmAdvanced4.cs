...
namespace frmSplash
{
    public partial class frmAdvanced4 : Form
    {
        public frmAdvanced4()
        {
            InitializeComponent();
            ...
            awnsers.Add("Hyper Text Transfer Protocol Speed");
            awnsers.Add("Hyper Text Transfer Protocol Secure");
            awnsers.Add("Hyper Text Transfer Protocol Single");
            awnsers.Add("Hyper Text Transfer Protocol Superspeed");
        ...
        private void btnNextQuestion_Click(object sender, EventArgs e)
        {
            ...
            if (rb1.Checked && rb1.Text == "Hyper Text Transfer Protocol Secure" || rb2.Checked && rb2.Text == "Hyper Text Transfer Protocol Secure" || rb3.Checked && rb3.Text == "Hyper Text Transfer Protocol Secure" || rb4.Checked && rb4.Text == "Hyper Text Transfer Protocol Secure")
            {
            ...
            this.Hide();
            frmAdvanced5 myNextScreen = new frmAdvanced5();
            myNextScreen.Show();
        }

        
        private void frmQuestion11_Load(object sender, EventArgs e)
        {
