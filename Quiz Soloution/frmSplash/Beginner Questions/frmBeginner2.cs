...
namespace frmSplash
{
    public partial class frmBeginner2 : Form
    {
        public frmBeginner2()
        {
            InitializeComponent();
            ...
            awnsers.Add("Universal Cereal Bus");
            awnsers.Add("Universal Speed Bus");
            awnsers.Add("Universal Serial Bus");
            awnsers.Add("Uniform Serial Bus");
        ...
        private void btnNextQuestion_Click_1(object sender, EventArgs e)
        {
            ...
            if (rb1.Checked && rb1.Text == "Universal Serial Bus" || rb2.Checked && rb2.Text == "Universal Serial Bus" || rb3.Checked && rb3.Text == "Universal Serial Bus" || rb4.Checked && rb4.Text == "Universal Serial Bus")
            {
            ...
            this.Hide();
            frmBeginner3 myNextScreen = new frmBeginner3();
            myNextScreen.Show();
        }
