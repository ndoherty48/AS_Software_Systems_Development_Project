...
namespace frmSplash
{
    public partial class frmBeginner4 : Form
    {
        public frmBeginner4()
        {
        ...
        private void btnNextQuestion_Click(object sender, EventArgs e)
        {
            ...
            if (rb1.Checked && rb1.Text == "Visual Studio" || rb2.Checked && rb2.Text == "Visual Studio" || rb3.Checked && rb3.Text == "Visual Studio" || rb4.Checked && rb4.Text == "Visual Studio")
            {
            ...
            this.Hide();
            frmBeginner5 myNextScreen = new frmBeginner5();
            myNextScreen.Show();
        }

        private void frmBeginner4_Load(object sender, EventArgs e)
        {
