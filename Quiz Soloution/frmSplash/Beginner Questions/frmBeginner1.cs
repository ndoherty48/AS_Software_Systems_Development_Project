...
namespace frmSplash
{
    public partial class frmBeginner1 : Form
    {
        public frmBeginner1()
        {
            InitializeComponent();
            ...
            awnsers.Add("Keyboard");
            awnsers.Add("Monitor");
            awnsers.Add("Graphics Tablet");
            awnsers.Add("Mouse");
        ...
        private void btnNextQuestion_Click(object sender, EventArgs e)
        {
            ...
            if (rb1.Checked && rb1.Text == "Monitor" || rb2.Checked && rb2.Text == "Monitor" || rb3.Checked && rb3.Text == "Monitor" || rb4.Checked && rb4.Text == "Monitor")
            {
            ...
            this.Hide();
            frmBeginner2 myNextScreen = new frmBeginner2();
            myNextScreen.Show();
        }
